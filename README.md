...
https://github.com/JetBrains/intellij-platform-plugin-template/blob/main/README.md

[![official JetBrains project](https://jb.gg/badges/official.svg)][jb:github]
[![Build](https://github.com/JetBrains/intellij-platform-plugin-template/workflows/Build/badge.svg)][gh:build]

> [!NOTE]
> Click the <kbd>Use this template</kbd> button and clone it in IntelliJ IDEA or Android Studio.

<!-- Plugin description -->
**Kotlin Compiler Plugin Template** is a repository that provides a pure template to make it easier to create a new plugin project for the Kotlin compiler.(check the [Creating a repository from a template][gh:template] article).
